...
struct Point3d
{
  ...
  bool operator == (Point3d& p2);	// == comparison of two points (p1 == p2 -> true)
  bool operator != (Point3d& p2);	// != comparison of two points (p1 != p2 -> true)
...
std::string Point3dToString(Point3d* pt);	///< returns the point coordinates as string "(x, y, z)"
