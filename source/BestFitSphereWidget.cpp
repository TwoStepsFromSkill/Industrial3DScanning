...
BestFitSphereWidget::BestFitSphereWidget(QWidget* parent)
    : BaseTabWidget(parent)
{
    ...
    m_mainWidget->setTitle(QString("Best Fit Sphere"));
...
void BestFitSphereWidget::deactivate()
{
    m_mainWidget->setChecked(false);
}

void BestFitSphereWidget::activate()
{
